import { EgoverseNftStaking } from "./../target/types/egoverse_nft_staking";
...
const program = anchor.workspace.EgoverseNftStaking as Program<EgoverseNftStaking>;
const programId = new PublicKey("BPRCax4zDLzppuapumnNaxfs9JjMRftxTrwMQrMkQHNi");
